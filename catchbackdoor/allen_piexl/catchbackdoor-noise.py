...
path_temp = []
x = np.random.uniform(0, 1, (1, 28, 28, 1))
...
#%%
print(np.argmax(model.predict(np.clip(gen_img1, a_max=255, a_min=0))))
...
plt.savefig('./all_together.png',  bbox_inches="tight", dpi=400)
plt.show()

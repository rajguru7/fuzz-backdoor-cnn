...
elif model_name == 'model3x':
    model1 = Model3x(input_tensor=input_tensor)
elif model_name == 'model4':
    model1 = Model4(input_tensor=input_tensor)
elif model_name == 'model4x':
    model1 = Model4x(input_tensor=input_tensor)
elif model_name == 'model4x1':
    model1 = Model4x1(input_tensor=input_tensor)
elif model_name == 'model4x2':
...
for i in range(img_num):
    ...
    while len(img_list) > 0:
        ...
        #changes below: by me
        loss_poison = K.mean(model1.get_layer('before_softmax').output[..., poison])
        ...
        for iters in range(iteration_times):
            ...
            if current_coverage - previous_coverage > 0.01 / (i + 1) and perturb_adversial < 0.005:

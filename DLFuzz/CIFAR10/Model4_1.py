...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Input, Dense, Activation, Flatten, Dropout, BatchNormalization
...
def Model4(input_tensor=None, train=False):
    ...
    model.add(Flatten())
    model.add(Dense(nb_classes, activation='softmax', name='before_softmax'))  
    print(model.summary())
